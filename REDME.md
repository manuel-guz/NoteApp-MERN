APP with a MERN STACK using MongoDB(mongoose as an ODM and Mongo Atlas as the on cloud data base). The APIrest is built in express framework bases using npm packages. 
